...
const AddCourses = () => {
  ...
  const searchStudent = async () => {
    ...
    try {
      const response = await axios.get(`/api/students/enrollment/${enrollmentNumber}`);
      ...
      if (response.data && response.data._id) {
        ...
        setExistingCourses(coursesResponse.data);
      }
  ...
  return (
    <div className="p-4  md:p-8 max-w-6xl mx-auto">
      <h1 className="text-3xl pt-20 font-bold mb-6">Add Courses to Student</h1>
